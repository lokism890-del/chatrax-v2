...
import { 
  ...
  TrendingDown, TrendingUp, Bell, Globe, Lock, UploadCloud, Shield, MousePointerClick, StickyNote, Link
} from 'lucide-react';
...
const BRAND_COLORS: Record<string, ThemeColor> = {
  emerald: { text: 'text-emerald-400', bg: 'bg-emerald-500', bgSubtle: 'bg-emerald-500/20', border: 'border-emerald-500/30', borderActive: 'border-emerald-500/50', focusBorder: 'focus:border-emerald-500/50', hoverBg: 'hover:bg-emerald-500/20', gradient: 'from-emerald-500 to-teal-500', shadow: 'shadow-[0_0_15px_rgba(16,185,129,0.4)]' },
  blue: { text: 'text-blue-400', bg: 'bg-blue-500', bgSubtle: 'bg-blue-500/20', border: 'border-blue-500/30', borderActive: 'border-blue-500/50', focusBorder: 'focus:border-blue-500/50', hoverBg: 'hover:bg-blue-500/20', gradient: 'from-blue-500 to-indigo-500', shadow: 'shadow-[0_0_15px_rgba(59,130,246,0.4)]' },
  purple: { text: 'text-purple-400', bg: 'bg-purple-500', bgSubtle: 'bg-purple-500/20', border: 'border-purple-500/30', borderActive: 'border-purple-500/50', focusBorder: 'focus:border-purple-500/50', hoverBg: 'hover:bg-purple-500/20', gradient: 'from-purple-500 to-fuchsia-500', shadow: 'shadow-[0_0_15px_rgba(168,85,247,0.4)]' },
  rose: { text: 'text-rose-400', bg: 'bg-rose-500', bgSubtle: 'bg-rose-500/20', border: 'border-rose-500/30', borderActive: 'border-rose-500/50', focusBorder: 'focus:border-rose-500/50', hoverBg: 'hover:bg-rose-500/20', gradient: 'from-rose-500 to-pink-500', shadow: 'shadow-[0_0_15px_rgba(244,63,94,0.4)]' },
  amber: { text: 'text-amber-400', bg: 'bg-amber-500', bgSubtle: 'bg-amber-500/20', border: 'border-amber-500/30', borderActive: 'border-amber-500/50', focusBorder: 'focus:border-amber-500/50', hoverBg: 'hover:bg-amber-500/20', gradient: 'from-amber-500 to-orange-500', shadow: 'shadow-[0_0_15px_rgba(245,158,11,0.4)]' }
};
...
export default function Dashboard() {
  ...
  // ─── RENDER HELPER FUNCTIONS (Abstracted to prevent truncation errors) ───
                         ...
                         return (
                           <div key={lead.id} draggable onDragStart={(e) => handleDragStart(e, lead.id)} onDragEnd={handleDragEnd} onClick={() => setSelectedLead(lead)} 
                             ...
                             <div className="flex justify-between items-start mb-0.5 pl-1">
                               <span className="font-sans text-sm font-semibold text-white drop-shadow-sm">{lead.full_name || 'Store Customer'}</span>
  ...
  const renderSettings = () => (
    <div className="flex flex-col h-full animate-[fade-in_0.3s_ease-out]">
      <div className="h-20 flex items-center justify-between px-6 border-b border-white/10 bg-[#111827]/80 backdrop-blur-xl shrink-0">
        <div><h2 className="text-lg font-bold text-white drop-shadow-md">System Settings</h2><p className="text-[10px] text-zinc-400 font-medium mt-0.5 tracking-wide">Manage your CRM integrations and workspace data</p></div>
      </div>
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
         <div className="max-w-6xl mx-auto grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
               ...
               <div className="bg-[#1F2937]/60 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl">
                  <div onClick={() => setSettings({...settings, audioAlerts: !settings.audioAlerts})} className="flex items-center justify-between p-3 bg-[#111827]/50 rounded-lg border border-white/5 hover:border-white/10 transition-colors cursor-pointer shadow-inner">
